document.addEventListener('DOMContentLoaded', function() {
    var contentQuery = document.getElementById('contentQuery');
    if (contentQuery) {
        contentQuery.focus();
    }
    ...
    document.addEventListener('click', function(e) {
        if (!e.target.closest('#searchOptions, #searchOptionsButton')) {
    ...
    if (typeof Suggestor === 'function') {
        ...
        new Suggestor(document.getElementById('contentQuery'), {
            ajaxinfo: {
