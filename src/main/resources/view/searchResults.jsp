			...
			<li id="result${s.index}">
				...
				<div class="site text-truncate">
					...
					<c:if test="${doc.has_cache=='true'}">
						<small class="hidden-until-lg"> <la:link
				...
				<div class="body" style="color:#545454">
					<c:if test="${thumbnailSupport && !empty doc.thumbnail}">
						<a class="link hidden-mobile" style="margin-right:1rem" href="${doc.url_link}" data-uri="${doc.url_link}" data-id="${doc.doc_id}"
							data-order="${s.index}"
						> <img src="${fe:url('/images/simple/blank.png')}"
